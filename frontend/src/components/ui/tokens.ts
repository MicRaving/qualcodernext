...
export const cls = {
  ...
  ghostRow: "rounded-sm p-1 text-text-secondary hover:bg-surface-higher hover:text-text-primary",
  countBadge:
  ...
  textarea: "rounded-sm border border-border bg-bg text-sm outline-none focus:border-accent",
  /** Floating popup panel (selection toolbar, annotate box, …). */
  popup: "rounded-md border border-border bg-surface shadow-lg",
