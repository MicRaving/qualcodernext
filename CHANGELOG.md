...
### Features
- collaboration presence + sync improvements (7bae23a)
...
### Other
- chore: collaboration presence + sync improvements (f6dbaa7)
...
### Features
- collaboration presence + sync improvements (3e1b5b6)
